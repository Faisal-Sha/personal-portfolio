const socialLinks = [
  {
    href: 'https://github.com/Faisal-Sha',
  ...
  {
    href: 'https://www.linkedin.com/in/faisalshahzad2302/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://x.com/iamfaisal2023',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
